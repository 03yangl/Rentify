...
const getListing = async (params:string) => {
    return await getListingById({listingId: params});
}
...
const EditModal = () => {
  ...
  //const listingId = editModal.listingId;
  const listing = getListing(editModal.listingId);
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          title="Edit the photo of your item"
